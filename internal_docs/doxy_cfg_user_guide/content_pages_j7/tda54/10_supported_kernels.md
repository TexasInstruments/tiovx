...
on the TDA5 platform.  When mapped to C7X DSP, it indicates if it is implemented
...
-------------------------------------------|--------------------------------------|--------------------------------------------|----------------------|
#tivxCaptureNode (support pending)         | CSIRX                                | MCU2                                       | No                   |
#tivxDisplayNode                           | DSS                                  | MCU0                                       | No                   |
#tivxTIDLNode                              | C7x + MMA                            | DSP0 / DSP1 / DSP2 / DSP3                  | Yes                  |
#tivxVpacVissNode (support pending)        | VPAC1_VISS / VPAC2_VISS / VPAC3_VISS | MCU2 (VPAC1) / MCU3 (VPAC2) / MCU4 (VPAC3) | Yes                  |
#tivxVpacLdcNode (support pending)         | VPAC1_LDC / VPAC2_LDC / VPAC3_LDC    | MCU2 (VPAC1) / MCU3 (VPAC2) / MCU4 (VPAC3) | Yes                  |
#tivxVpacNfGenericNode (support pending)   | VPAC1_NF / VPAC2_NF / VPAC3_NF       | MCU2 (VPAC1) / MCU3 (VPAC2) / MCU4 (VPAC3) | Yes                  |
#tivxVpacNfBilateralNode (support pending) | VPAC1_NF / VPAC2_NF / VPAC3_NF       | MCU2 (VPAC1) / MCU3 (VPAC2) / MCU4 (VPAC3) | Yes                  |
#tivxVpacMscScaleNode (support pending)    | VPAC1_MSC / VPAC2_MSC / VPAC3_MSC    | MCU2 (VPAC1) / MCU3 (VPAC2) / MCU4 (VPAC3) | Yes                  |
#tivxVpacMscPyramidNode (support pending)  | VPAC1_MSC / VPAC2_MSC / VPAC2_MSC    | MCU2 (VPAC1) / MCU3 (VPAC2) / MCU4 (VPAC3) | Yes                  |
#tivxDmpacSdeNode (support pending)        | DMPAC_SDE                            | MCU1                                       | Yes                  |
#tivxDmpacDofNode (support pending)        | DMPAC_DOF                            | MCU1                                       | Yes                  |
#tivxCsitxNode (support pending)           | CSITX                                | MCU2                                       | Yes                  |
#tivxDisplayM2MNode (support pending)      | DSS                                  | MCU2                                       | Yes                  |
#tivxObjArraySplitNode                     | MPU                                  | A720 / MCU2                                | Yes                  |
