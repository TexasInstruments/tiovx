...
TEST(tivxInternalEventQueue, negativeTestownRegisterEvent)
{
    ...
    ASSERT_EQ_VX_STATUS(VX_ERROR_NOT_SUPPORTED, ownRegisterEvent(ref2, INVALID_QUEUE_TYPE, VX_EVENT_NODE_COMPLETED, 0, 0));
    ASSERT_EQ_VX_STATUS(VX_ERROR_INVALID_REFERENCE, ownRegisterEvent(ref3, INVALID_QUEUE_TYPE, VX_EVENT_NODE_COMPLETED, 0, 0));
    ...
    ASSERT_EQ_VX_STATUS(VX_ERROR_INVALID_PARAMETERS, ownRegisterEvent((vx_reference)graph, INVALID_QUEUE_TYPE, VX_EVENT_GRAPH_PARAMETER_CONSUMED, 0, 222));
    ...
    /* wrong queue type */
    ASSERT_EQ_VX_STATUS(VX_ERROR_NOT_SUPPORTED, ownRegisterEvent((vx_reference)graph, INVALID_QUEUE_TYPE, VX_EVENT_GRAPH_PARAMETER_CONSUMED, 0, 222));      
    vxReleaseNode(&node);
