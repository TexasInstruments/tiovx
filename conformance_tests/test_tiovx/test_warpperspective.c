...
#define NEGATIVE_PARAMETERS \
    CT_GENERATE_PARAMETERS("random", ADD_SIZE_18x18, ADD_VX_BORDERS_REQUIRE_REPLICATE_ONLY, ADD_VX_INTERPOLATION_TYPE_NEAREST_NEIGHBOR, ADD_VX_MATRIX_PARAM_WARP_PERSPECTIVE, ARG, own_generate_random, NULL, 128, 128)

TEST_WITH_ARG(tivxWarpPerspective, negativeTestBorderMode, Arg,
    NEGATIVE_PARAMETERS
)
{
    vx_context context = context_->vx_context_;
