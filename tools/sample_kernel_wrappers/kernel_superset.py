...
kernel.setParameter(Type.USER_DATA_OBJECT,  Direction.INPUT, ParamState.REQUIRED, "IN_USER_DATA_OBJECT")
kernel.setParameter(Type.RAW_IMAGE,         Direction.INPUT, ParamState.REQUIRED, "IN_RAW_IMAGE")
kernel.setParameter(Type.TENSOR,            Direction.INPUT, ParamState.REQUIRED, "IN_TENSOR")
...
kernel.setParameter(Type.USER_DATA_OBJECT,  Direction.OUTPUT, ParamState.REQUIRED, "OUT_USER_DATA_OBJECT")
kernel.setParameter(Type.RAW_IMAGE,         Direction.OUTPUT, ParamState.REQUIRED, "OUT_RAW_IMAGE")
kernel.setParameter(Type.TENSOR,            Direction.OUTPUT, ParamState.REQUIRED, "OUT_TENSOR")
