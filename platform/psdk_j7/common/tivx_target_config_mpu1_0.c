...
{
    tivxTargetCreateTargetId(TIVX_TARGET_ID_A72_0, "TIVX_CPU0");
    tivxTargetCreateTargetId(TIVX_TARGET_ID_A72_1, "TIVX_CPU1");
    tivxTargetCreateTargetId(TIVX_TARGET_ID_A72_2, "TIVX_CPU2");
    tivxTargetCreateTargetId(TIVX_TARGET_ID_A72_3, "TIVX_CPU3");
}

void tivxPlatformDeleteTargets(void)
{
    tivxTargetDeleteTargetId(TIVX_TARGET_ID_A72_0);
    tivxTargetDeleteTargetId(TIVX_TARGET_ID_A72_1);
    tivxTargetDeleteTargetId(TIVX_TARGET_ID_A72_2);
    tivxTargetDeleteTargetId(TIVX_TARGET_ID_A72_3);
}
