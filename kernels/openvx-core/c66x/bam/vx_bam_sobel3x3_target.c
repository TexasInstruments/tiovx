    ...
    uint16_t num_params, void *priv_arg)
{
    ...
    if (VX_SUCCESS == status)
    {
        ...
        if (NULL != prms)
        {
            ...
            if ((dstx != NULL) && (dsty != NULL))
            {
                status = BAM_VXLIB_sobel_3x3_i8u_o16s_o16s_getKernelInfo( NULL,
            ...
            else if (dstx != NULL)
            {
                ...
                status = BAM_VXLIB_sobelX_3x3_i8u_o16s_getKernelInfo( NULL,
                                                                     &frame_params.kernel_info);
            ...
            else
            {
                ...
                status = BAM_VXLIB_sobelY_3x3_i8u_o16s_getKernelInfo( NULL,
                                                                     &frame_params.kernel_info);
