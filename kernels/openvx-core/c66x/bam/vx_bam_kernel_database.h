...
typedef enum _bam_ti_kernelid
{
    ...
    BAM_KERNELID_VXLIB_MEDIAN_3X3_I8U_O8U = 60,
    BAM_KERNELID_VXLIB_MEDIAN_MXN_I8U_I8U_O8U = 61,
    BAM_KERNELID_VXLIB_MINMAXLOC_I16S = 62,
    BAM_KERNELID_VXLIB_MINMAXLOC_I8U = 63,
    BAM_KERNELID_VXLIB_MULTIPLY_I16S_I16S_O16S = 64,
    BAM_KERNELID_VXLIB_MULTIPLY_I8U_I16S_O16S = 65,
    BAM_KERNELID_VXLIB_MULTIPLY_I8U_I8U_O16S = 66,
    BAM_KERNELID_VXLIB_MULTIPLY_I8U_I8U_O8U = 67,
    BAM_KERNELID_VXLIB_NORML1_I16S_I16S_O16U = 68,
    BAM_KERNELID_VXLIB_NORML2_I16S_I16S_O16U = 69,
    BAM_KERNELID_VXLIB_NOT_I8U_O8U = 70,
    BAM_KERNELID_VXLIB_OR_I8U_I8U_O8U = 71,
    BAM_KERNELID_VXLIB_PHASE_I16S_I16S_O8U = 72,
    BAM_KERNELID_VXLIB_SCALEIMAGENEAREST_I8U_O8U = 73,
    BAM_KERNELID_VXLIB_SOBEL_3X3_I8U_O16S_O16S = 74,
    BAM_KERNELID_VXLIB_SOBEL_5X5_I8U_O16S_O16S = 75,
    BAM_KERNELID_VXLIB_SOBEL_7X7_I8U_O16S_O16S = 76,
    BAM_KERNELID_VXLIB_SOBEL_7X7_I8U_O32S_O32S = 77,
    BAM_KERNELID_VXLIB_SOBELX_3X3_I8U_O16S = 78,
    BAM_KERNELID_VXLIB_SOBELY_3X3_I8U_O16S = 79,
    BAM_KERNELID_VXLIB_SUBTRACT_I16S_I16S_O16S = 80,
    BAM_KERNELID_VXLIB_SUBTRACT_I8U_I16S_O16S = 81,
    BAM_KERNELID_VXLIB_SUBTRACT_I8U_I8U_O16S = 82,
    BAM_KERNELID_VXLIB_SUBTRACT_I8U_I8U_O8U = 83,
    BAM_KERNELID_VXLIB_TABLELOOKUP_I16S_O16S = 84,
    BAM_KERNELID_VXLIB_TABLELOOKUP_I8U_O8U = 85,
    BAM_KERNELID_VXLIB_THRESHOLDBINARY_I8U_O8U = 86,
    BAM_KERNELID_VXLIB_THRESHOLDRANGE_I8U_O8U = 87,
    BAM_KERNELID_VXLIB_XOR_I8U_I8U_O8U = 88,
