...
typedef enum _bam_ti_kernelid
{
    ...
    BAM_KERNELID_VXLIB_HISTOGRAM_I8U_O32U = 8,
    BAM_KERNELID_VXLIB_NORML1_I16S_I16S_O16U = 9,
    BAM_KERNELID_VXLIB_NORML2_I16S_I16S_O16U = 10,
    BAM_KERNELID_VXLIB_SOBEL_3X3_I8U_O16S_O16S = 11,
    BAM_KERNELID_VXLIB_SOBEL_5X5_I8U_O16S_O16S = 12,
    BAM_KERNELID_VXLIB_SOBEL_7X7_I8U_O16S_O16S = 13,
    BAM_KERNELID_VXLIB_SOBELX_3X3_I8U_O16S = 14,
    BAM_KERNELID_VXLIB_SOBELY_3X3_I8U_O16S = 15,
    BAM_KERNELID_VXLIB_TABLELOOKUP_I16S_O16S = 16,
    BAM_KERNELID_VXLIB_TABLELOOKUP_I8U_O8U = 17,
