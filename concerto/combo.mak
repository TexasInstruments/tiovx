...
TARGET_OBJ_OUT  := $(call MAKE_OBJ_OUT,$(HOST_ROOT))
TARGET_EXE_OUT  := $(call MAKE_EXE_OUT,$(HOST_ROOT))
...
$(info TARGET_OBJ_OUT=$(TARGET_OBJ_OUT))
$(info TARGET_EXE_OUT=$(TARGET_EXE_OUT))
