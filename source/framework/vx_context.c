...
<justification end> */
                    else if (status == (vx_status)VX_ERROR_TIMEOUT) /* TIOVX-1929- LDRA Uncovered Branch Id: TIOVX_BRANCH_COVERAGE_TIVX_CONTEXT_UBR012 */
/* LDRA_JUSTIFY_END */
                    {
...
<justification end> */
                    else if (status == (vx_status)VX_ERROR_TIMEOUT) /* TIOVX-1929- LDRA Uncovered Branch Id: TIOVX_BRANCH_COVERAGE_TIVX_CONTEXT_UBR015 */
/* LDRA_JUSTIFY_END */              
                    {
                        /* Queue the object into the pend queue for later
                        * action.
