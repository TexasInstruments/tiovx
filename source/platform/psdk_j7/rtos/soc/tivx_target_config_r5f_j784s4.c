...
void ownPlatformCreateTargets(void)
{
    ...
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_VPAC2_LDC1, 2u, "TIVXV2LDC1", 15u);
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_VPAC2_MSC1,    3u, "TIVXV2MSC1", 8u);
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_VPAC2_MSC2,    4u, "TIVXV2MSC2", 8u);
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_VPAC2_VISS1,   5u, "TIVXV2VISS1", 13u);
    ...
    tivxPlatformCreateTargetId((vx_enum)TIVX_TARGET_ID_DMPAC_DOF,    15u, "TIVX_DOF", 8u);
