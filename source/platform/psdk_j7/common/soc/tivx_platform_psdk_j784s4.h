...
typedef enum _tivx_target_id_e {
    ...
    TIVX_TARGET_ID_VPAC2_NF = TIVX_MAKE_TARGET_ID(TIVX_CPU_ID_MCU2_1, 3u),

    /*! \brief target ID for VPAC2 LDC1 */
    TIVX_TARGET_ID_VPAC2_LDC1 = TIVX_MAKE_TARGET_ID(TIVX_CPU_ID_MCU2_1, 4u),

    /*! \brief target ID for VPAC2 MSC1 */
    TIVX_TARGET_ID_VPAC2_MSC1 = TIVX_MAKE_TARGET_ID(TIVX_CPU_ID_MCU2_1, 5u),

    /*! \brief target ID for VPAC2 MSC2 */
    TIVX_TARGET_ID_VPAC2_MSC2 = TIVX_MAKE_TARGET_ID(TIVX_CPU_ID_MCU2_1, 6u),

    /*! \brief target ID for VPAC2 VISS1 */
    TIVX_TARGET_ID_VPAC2_VISS1 = TIVX_MAKE_TARGET_ID(TIVX_CPU_ID_MCU2_1, 7u),
